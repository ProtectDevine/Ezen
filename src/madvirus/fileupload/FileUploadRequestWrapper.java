...
/*httpservletRequest API이용하려고 상속*/
...
public class FileUploadRequestWrapper extends HttpServletRequestWrapper {
	...
	public FileUploadRequestWrapper(HttpServletRequest request) throws
	...
	public FileUploadRequestWrapper(HttpServletRequest request, int threshold, 
			int max, String repositoryPath) throws FileUploadException, UnsupportedEncodingException {
		super(request);
	...
	private void parsing(HttpServletRequest request, int threshold, int max,
			String repositoryPath) throws FileUploadException, UnsupportedEncodingException {
