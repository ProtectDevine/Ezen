...
public class BoardDBBean {		//(DAO/ 처리빈)
	...
	public void insertArticle(BoardDataBean article) throws Exception{
		...
		//답변글인지 일반글인지 구분해서 입력하는 로직
		int num = article.getNum();
		int ref = article.getRef(); //메인글과 답변글 묶기
		int re_step = article.getRe_step(); //화면출력순서
		int re_level = article.getRe_level(); //메인글인지, 답변글인지 구분
		int number = 0;
		String sql = "";
