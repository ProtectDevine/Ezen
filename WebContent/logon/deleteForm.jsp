...
<meta charset="EUC-KR">
<title>회원탈퇴</title>
<link href="sttylse.css" rel="stylesheet" type="text/css">
...
<form name="myform" action="deletePro.jsp" method="post" onSubmit="retunr checkIt()">
...
<tr hieght="30">
	...
	<tr height="30">
		<td colspan="2" agign="middle" bgcolor="<%=value_c %>">
