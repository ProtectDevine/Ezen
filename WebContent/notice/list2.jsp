...
<head>
    ...
    <link href="EzenWepStudy/css/customer/layout.css" type="text/css" rel="stylesheet" />
    <style>
        ...
        #visual .content-container{	
            ...
            background: url("EzenWepStudy/images/customer/visual.png") no-repeat center;
        }
    </style>
</head>
...
<body>
    ...
    <header id="header">
        ...
        <div class="content-container">
            ...
            <h1 id="logo">
                <a href="index.html">
                    <img src="EzenWepStudy/images/logo.png" alt="뉴렉처 온라인" />
