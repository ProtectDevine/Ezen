...
<body bgcolor="${bodyback_c}">
	<form method="post" action="/EzenWepStudy/logon2/modifyPro.do" name="userinput" onsubmit="return checkIt()">
    	...
    	<tr> 
      		<td colspan="2" align="center" bgcolor="${value_c}"> 
       		...
       		<input type="button" value="취  소" onclick="document.location.href='/EzenWepStudy/logon2/main.do'">      
      		</td>
    	</tr>
  </table>
</form>
