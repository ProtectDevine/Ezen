...
<script language="JavaScript">
	...
	if (userinput.id.value == "") {
		...
		url = "/EzenWepStudy/logon2/confirmId.do?id=" + userinput.id.value ;
...
<form method="post" action="/EzenWepStudy/logon2/inputPro.do" name="userinput"
	...
	<table width="600" border="1" cellspacing="0" cellpadding="3" align="center">
    	...
    	<tr> 
      		<td colspan="2" align="center" bgcolor="${value_c}"> 
          		...
          		<input type="button" value="가입안함" onclick="document.location.href='/EzenWepStudy/logon2/main.do'">
      		</td>
    	</tr>
  	</table>
</form>
